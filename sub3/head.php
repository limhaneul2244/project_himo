...
<head>
    ...
    <link rel="stylesheet" href="../../sub3/css/himo_sub_3.css">
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR&family=Roboto&display=swap" rel="stylesheet">

    <script src="/mainjs/jquery-3.6.0.min.js"></script>
...
<body>
    <div id="skip_nav">
        ...
        <a href="#g5_table">홍보센터 게시판 바로가기</a>
    </div>
    <div id="wrap">
        <header id="header">
            ...
            <div id="header_inner">
                ...
                <div id="main_header_bottom">
                    <h1 id="logo">
                        <div id="logo_inner">
                            <a href="/index.html">
                                <img src="/common/images/himo_logo_maxsize.png" alt="himo logo">
                            </a>
                        </div>
                    </h1>
                    <nav id="gnb_bottom">
